...
export const users = sqliteTable('users', {
  ...
  ageGroup: text('age_group'), // '11-13' | '14-17' | '18-21'
...
export const consentRecords = sqliteTable('consent_records', {
  ...
  isSelfConsent: integer('is_self_consent', { mode: 'boolean' }).notNull(),
...
export const questionBank = sqliteTable('question_bank', {
  ...
  ageGroup: text('age_group').notNull(), // '11-13' | '14-17' | '18-21'
  category: text('category').notNull(), // 'immunosuppression' | 'tacrolimus' | ...
...
export const questionProgress = sqliteTable('question_progress', {
  ...
  userQuestionUnique: uniqueIndex('question_progress_user_question_idx').on(
    table.userId,
    table.questionId
  ),
}));
