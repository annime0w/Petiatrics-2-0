...
//const PlaceholderImage = require('@/assets/images/Containers/contTest3.png'); NOT BEING USED
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{marginTop: 150, marginBottom: 150}} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity onPress={() => router.push({ pathname: '../gamesPageItems/qaGame' })}>
          <ImageBackground
            source={require('../../assets/images/Containers/qaCont.png')}
            style={localStyles.container}
            resizeMode="contain"
          >
            <View style={localStyles.qaInner}>
              ...
              <View style={localStyles.qaSymbols}>
                <View style={localStyles.qaChip}>
                  <Text style={localStyles.qaChipText}>?</Text>
                </View>
                <View style={localStyles.qaChip}>
                  <Text style={localStyles.qaChipText}>!</Text>
                </View>
